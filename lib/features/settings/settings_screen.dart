                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Stack(
                              ...
                              children: [
                                Assets.images.settingsAvatar.image(width: 110),
                                Positioned(
                                  bottom: 0,
                                  child: Container(
                                    width: 121,
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image:
                                        Assets.images.settingsPopup.provider(),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                                child: const Text(
          ...
          children: [
            Positioned(
              ...
              child: SizedBox(
                ...
                height: 40,
                child: Text(
                  'Upgrade to PRO and get a deeper connection with me!',
                  style: TextStyle(
                    color: Color(0xFFFBFBFB),
                    fontSize: 12,
