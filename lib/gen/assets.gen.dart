...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/feedback_icon.svg
  ...
  /// File path: assets/icons/pro_icon.svg
  SvgGenImage get proIcon => const SvgGenImage('assets/icons/pro_icon.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/alice_big_avatar.jpg
  AssetGenImage get aliceBigAvatar =>
      const AssetGenImage('assets/images/alice_big_avatar.jpg');
  ...
  /// File path: assets/images/start_screen_background.jpg
  AssetGenImage get startScreenBackground =>
...
class $AssetsPaywallGen {
  ...
  /// File path: assets/paywall/gallery_icon.svg
  SvgGenImage get galleryIcon =>
      const SvgGenImage('assets/paywall/gallery_icon.svg');

  /// File path: assets/paywall/limits_icon.svg
  SvgGenImage get limitsIcon =>
      const SvgGenImage('assets/paywall/limits_icon.svg');

  /// File path: assets/paywall/paywall_image.png
  AssetGenImage get paywallImage =>
      const AssetGenImage('assets/paywall/paywall_image.png');

  /// File path: assets/paywall/pro_icon.svg
  SvgGenImage get proIcon => const SvgGenImage('assets/paywall/pro_icon.svg');

  /// List of all assets
  List<dynamic> get values => [galleryIcon, limitsIcon, paywallImage, proIcon];
}
